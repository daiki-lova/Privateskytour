          ...
          <div className="flex items-center justify-between h-20">
            ...
            >
              <div className="flex-shrink-0">
                <div className={`h-8 w-auto transition-all duration-300 ${
                  isVisible ? "" : "brightness-0 invert"
                }`}>
                  <ImageWithFallback
                    src={logoImage}
                    alt="PRIVATESKY TOUR"
              ...
              <div className="ml-10 flex items-center space-x-6">
                {navItems.map((item) => (
                  <motion.button
                    ...
                    className={`px-3 py-2 transition-colors duration-300 relative group font-bold tracking-wide ${
                      isVisible
